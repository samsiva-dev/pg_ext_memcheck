...
|---|---|---|---|
| `scenario_name` | `text` | — | Scenario name. Currently available: `growth_benchmark`, `tx_abort_loop`, `shmem_sentinel_probe`. See [Stress Scenarios](/scenarios/). |
...
| `context_bloat` | 2 | Planned | Total allocated bytes in the context tree increased monotonically across all iterations of a growth benchmark scenario. |
