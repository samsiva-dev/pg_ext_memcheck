...
| Parameter | Type | Default | Description |
|---|---|---|---|
| `scenario_name` | `text` | — | Scenario name. All four ship in 0.1.0 Beta: `growth_benchmark`, `tx_abort_loop`, `shmem_sentinel_probe`, `wrong_context_probe`. See [Stress Scenarios](/scenarios/). |
