...
<table>
  ...
  <tbody>
    <tr><td><code>ts</code></td><td><code>2026-05-10 14:32:01 UTC</code></td></tr>
    <tr><td><code>backend_pid</code></td><td><code>12345</code></td></tr>
    <tr><td><code>detail</code></td><td><code>"Context present in post-query snapshot but not pre-query"</code></td></tr>
    <tr><td><code>severity</code></td><td><code>WARNING</code>, <code>INFO</code>, <code>ERROR</code></td></tr>
    <tr><td><code>check_type</code></td><td><code>context_leak</code>, <code>wrong_ctx_alloc</code>, <code>shmem_overrun</code>, etc.</td></tr>
    <tr><td><code>source_lib</code></td><td><code>your_extension.dylib</code></td></tr>
  </tbody>
</table>
...
<Aside type="note" title="Available scenarios">
  Six scenarios are available: `growth_benchmark`, `tx_abort_loop`, `shmem_sentinel_probe`, and `wrong_context_probe` run in-process. `use_after_reset` and `oom_simulation` run in a crash-isolated BGWorker process. Additional scenarios (`context_reset_storm`, `concurrent_backends`, `dsm_lifecycle_check`) are deferred to a later release. See the [Stress Scenarios](/scenarios/) page for details.
</Aside>
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td><code>all</code> / <code>executor</code> / <code>none</code> — controls which execution phases are hooked. See <a href="/api/#pg_ext_memcheckmemcheck_mode">API reference</a>.</td>
    </tr>
    <tr>
      <td><code>pg_ext_memcheck.min_leak_bytes</code></td>
      <td><code>int</code></td>
      <td><code>8192</code></td>
      <td>Context growth smaller than this (in bytes) is silently ignored by the leak detector.</td>
    </tr>
    <tr>
      <td><code>pg_ext_memcheck.bloat_min_bytes</code></td>
      <td><code>int</code></td>
      <td><code>8192</code></td>
      <td>Minimum cumulative growth (in bytes) for a context to be reported as bloating by <code>growth_benchmark</code>.</td>
    </tr>
  </tbody>
</table>
