...
|---|---|---|---|
| `pg_ext_memcheck.memcheck_mode` | `enum` | `none` | `all` / `executor` / `none` — controls which execution phases are hooked. See [API reference](/api/#pg_ext_memcheckmemcheck_mode). |
