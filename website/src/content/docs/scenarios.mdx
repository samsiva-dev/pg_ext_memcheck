...
<Aside type="note" title="Availability">
  Six scenarios are available: `growth_benchmark`, `tx_abort_loop`, `shmem_sentinel_probe`, `wrong_context_probe`, `use_after_reset`, and `oom_simulation`. The last two run in a crash-isolated BGWorker process. The remaining scenarios (`context_reset_storm`, `concurrent_backends`, `dsm_lifecycle_check`) are deferred to a later release and are not yet implemented.
</Aside>
...
<table>
  ...
  <tbody>
    <tr><td><code>iterations</code></td><td><code>50</code></td><td>Number of invocations</td></tr>
    <tr><td><code>reset_frequency</code></td><td><code>1</code></td><td>Reset context every N invocations</td></tr>
  </tbody>
</table>
...
<table>
  ...
  <tbody>
    <tr><td><code>workers</code></td><td><code>4</code></td><td>Number of concurrent backend workers</td></tr>
    <tr><td><code>iterations</code></td><td><code>50</code></td><td>Invocations per worker</td></tr>
  </tbody>
</table>
